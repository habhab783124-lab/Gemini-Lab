...
namespace GeminiLab.Tests.EditMode
{
    public sealed class IndoorDoorInteractionTests
    {
        ...
        {
            Assert.IsTrue(_door.TryInteract()); Assert.AreEqual(80,_angel.Energy); Assert.IsFalse(_door.IsDialogueVisible);
        ...
        public void EitherPetCanInitiate_ClosingDoesNotSettleTwice(bool devilInitiates)
        {
            ...
            _door.SetOpen(true); Assert.IsTrue(_door.TryInteract()); Assert.IsTrue(_door.IsDialogueVisible);
            ...
            Assert.IsTrue(_door.TryInteract()); Assert.IsFalse(_door.IsDialogueVisible);
        ...
        public void NeedSpaceChangesNoStats_AndPrecedesWarm()
        {
            ...
            _door.SetOpen(true); _door.TryInteract();
        ...
        public void SpeechAppearsOnCorrectPetInOrder_ThenExpiresWithoutResettling(PetId initiator, SocialResponseType response)
        {
            ...
            var topic = Catalog().GetTopic(initiator,0);
            _door.SetOpen(true); _door.TryInteract();
        ...
        {
            _angel.Energy=9; _door.SetOpen(true); _door.TryInteract();
