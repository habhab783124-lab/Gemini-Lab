...
## 命名规范
1. 静态图优先使用中文语义命名：
   - 家具资源：`家具_{类别}_{对象}_{主题}_{编号}.png`
   - 示例：`家具_床_天使_01.png`
   - 示例：`家具_装饰_书柜_天使_01.png`
2. 序列帧优先使用中文语义命名：
   - `家具_{对象}_{动作}_{方向}_{帧号4位}.png`
   - 示例：`家具_台灯_闪烁_正面_0001.png`
3. 预览 GIF：
   - `家具_{对象}_{动作}_预览.gif`

当前项目里，凡是要进入家具交互/状态逻辑的静态图，命名里应优先出现这些中文类别词之一：
- `床`
- `工作桌`
- `休闲`
- `竖琴`
