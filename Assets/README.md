...
Gemini-Lab 是一款基于 **Unity 2022 LTS / 2D 模板 (URP 2D Renderer)** 开发的新一代非像素风虚拟宠物 AI 交互客户端。项目通过深度集成 OpenClaw Gateway，结合分层有限状态机 (HFSM) 与性格驱动大模型，实现了一个具备独立性格、多场景无缝切换及高自由度交互的沉浸式宠物陪伴生态。
